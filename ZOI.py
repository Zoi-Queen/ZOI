...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://https://github.com/Zoi-Queen/approval.txt/blob/main/server.txt').text
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		print("%s [%s•%s] %sTOOL NAME : %sZOYA-QUEEN"%(G,R,G,B,G))

		print("%s [%s•%s] %sVERSION   : %s7.6.0"%(G,R,G,B,G))
